...
class BaseTestExampleDataValid:
    ...
    def test_additional_fields(self):
        """Test that there are no additional fields. Uses libcoveofds library."""
        worker = AdditionalFields(self.schema)
        results = worker.process(self.get_data())
        assert results == {}

    def test_jsonschema_validation(self):
        """Test that there are no JSON Schema validation errors. Uses libcoveofds library."""
    ...
    def test_python_validation(self):
        """Test that there are no Python validation errors. Uses libcoveofds library."""
...
class TestNetworkPackage(BaseTestExampleDataValid):
    """
    Tests whether examples/json/network-package.json is valid.
    """
...
class TestMultipleNetworks(BaseTestExampleDataValid):
    """
    Tests whether examples/json/multiple-networks.json is valid.
    """

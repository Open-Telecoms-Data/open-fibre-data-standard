...
FROM "nodes.csv".nodes n
    LEFT JOIN "networks.csv".networks networks
        ON n."id" = networks."id"
    LEFT JOIN node_network_providers
        ON n."nodes/0/id" = node_network_providers."nodes/0/id"
    LEFT JOIN node_international_connections
        ON n."nodes/0/id" = node_international_connections."nodes/0/id";

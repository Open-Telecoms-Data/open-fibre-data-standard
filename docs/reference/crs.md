...
Coordinates in OFDS data modelust be specified in the coordinate reference system (CRS) [required by GeoJSON](https://datatracker.ietf.org/doc/html/rfc7946#section-4):

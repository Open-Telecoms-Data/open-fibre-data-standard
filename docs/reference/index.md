...
The [data model reference](data_model/index.md) is the canonical reference for the entities, attributes and relationships that make up the Open Fibre Data Standard (OFDS) data model.

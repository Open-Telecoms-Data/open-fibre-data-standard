        ...
        for table_name in table_names:
            ...
            if table_name.startswith("codelist"):
                ...
                mapping_tables.append({
                   "Table": f"`{table_name}`",
                   "base_id FK": f"{metadata_rows[0]['Reference Table']}.{metadata_rows[0]['Reference Column']}",
                   "related_id FK": f"{metadata_rows[1]['Reference Table']}.{metadata_rows[1]['Reference Column']}"
                })
